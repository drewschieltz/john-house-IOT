    ...
    ***************************************************************************** */
    ...
    var Auth0Plugin = /** @class */ (function () {
        ...
        Auth0Plugin.prototype.install = function (app) {
            this._client = new hc(__assign(__assign({}, this.clientOptions), { auth0Client: {
                    name: 'auth0-vue',
                    version: version
                } }));
        ...
        Auth0Plugin.prototype.logout = function (options) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.__proxy(function () { return _this._client.logout(options); }, options === null || options === void 0 ? void 0 : options.localOnly)];
                });
            });
        };
